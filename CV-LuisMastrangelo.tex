...
\cventry{Current position \\ Aug 2019--\emph{to date}}{Technical Consultant}{DB\&L Services SA}{Lugano, Switzerland}{}{IT infrastructure support for Monitoring Operations in Corporate Banking Clients.}
...
\cvitem{Languages}{Java, C\#, C/C++, Scala, Haskell, Python, R, JavaScript/TypeScript, Go, Perl, \LaTeX, LLVM/Clang, VB.NET/6, ASP/ASP.NET, PHP, Assembler, Pascal}
\cvitem{Paradigms}{OOP, Design by Contract, Functional and Logic Programming, UML, Design Patterns, Database Design, Data Science \& Analitics, Mining, Visualization}
\cvitem{Databases}{SQL, Datalog/QL, PostgreSQL, MySQL, SQL Server, Oracle, SQLite}
